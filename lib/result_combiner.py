...
# --combine_type DoCM
# --result_info /home/lqh/Codes/Python/RNA-SSNV/output/BLCA.RNA_only.driver.table \
# --DoCM_info /home/lqh/Codes/Python/Integrative_Analysis_Bioinformatics_Pipeline/tables/DoCM/BLCA.RNA_only.driver.table.DoCM.txt \
# --output_info /home/lqh/Codes/Python/RNA-SSNV/output/BLCA.RNA_only.driver.DoCM.table
...
if __name__ == '__main__':
    ...
    if args.combine_type=="DoCM":
        ...
        DoCM_info = DoCM_info[["chromosome", 'pos38', 'read', 'variant']]
        DoCM_info['chromosome'] = "chr" + DoCM_info['chromosome'].astype(str)
        DoCM_info.columns = ["Chromosome", 'Start_Position', 'Reference_Allele', "Tumor_Allele1"]
        DoCM_info.drop_duplicates(subset=None, keep='first', inplace=True)
